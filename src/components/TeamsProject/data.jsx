...
function TeamsProject() {
  ...
  return (
    <section className='mini-container teamsProject-container'>
      ...
      <div className='tabsMenu'>
        ...
        <div className='tabBtn'>
          ...
          <button onClick={() => setActiveTab('Figma')}>Figma</button>
        </div>
        <div className='tabBtn'>
          ...
          <button onClick={() => setActiveTab('Linear')}>Linear</button>
        </div>
        <div className='tabBtn'>
          ...
          <button onClick={() => setActiveTab('Slack')}>Slack</button>
        </div>
        <div className='tabBtn'>
